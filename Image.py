...
class MonkeyXRayApp:
    def __init__(self, root):
        ...
        tk.Label(self.panel, text="X-Ray Analysis Tools", font=("Helvetica", 16, "bold"), bg="#f4f4f4").pack(pady=(0, 20))

        # 1. File Group
        group_file = tk.LabelFrame(self.panel, text="File Operations", font=("Arial", 10, "bold"), bg="#f4f4f4", padx=5, pady=5)
        ...
        # 3. Processing
        group_proc = tk.LabelFrame(self.panel, text="Step 2: Processing", font=("Arial", 10, "bold"), bg="#f4f4f4", padx=5, pady=5)
        ...
        tk.Label(group_proc, text="Threshold Adjustment:", bg="#f4f4f4").pack(anchor=tk.W, pady=(5,0))
